...
<head>
    ...
    <meta name="description" content="MES | MIREA EDUCATION SYSTEM">
    <meta name="keywords" content="edu,ru">
    <meta name="author" content="ikbo">
    <!-- The above 6 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>MIREAVN EDUCATION | 404</title>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('public/assets/images/mirea.png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('public/assets/images/mirea.png')}}" />
...
<div class="app app-error align-content-stretch d-flex flex-wrap">
    <div class="app-error-info">
        <h5>Lỗi 404!</h5>
        <span>Trang yêu cầu không được tìm thấy.</span>
        <a href="{{route('index')}}" class="btn btn-dark">Trang chủ</a>
    </div>
